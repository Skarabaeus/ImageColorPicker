...
this.$selectedColor.css("backgroundColor"),b=255,h=255;varblue=255;var g=null;if(a.substring(0,1)==="#"){b=this._h2d(a.substring(0,2));h=this._h2d(a.substring(2,2));blue=this._h2d(a.substring(4,2))}else if(a.substring(0,4)==="rgba"){g=/rgba\((.+),(.+),(.+)\)/i.exec(a);b=g[1].trim();h=g[2].trim();blue=g[3].trim()}else if(a.substring(0,3)==="rgb"){g=/rgb\((.+),(.+),(.+)\)/i.exec(a);b=g[1].trim();h=g[2].trim();blue=g[3].trim()}return"#"+this._d2h(b)+this._d2h(h)+this._d2h(blue)},_d2h:function(a){a=parseInt(a)?
